...
public class LoansController {
    ...
    private final ILoansSevice loansService;
    ...
    public LoansController(ILoansSevice loansSevice) {
        this.loansService = loansSevice;
    }
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoans(@RequestHeader("eazybank-correlation-id")String correlationId,@RequestParam String mobileNumber){
    ...
    @Operation(
            summary = "Get build info Loans",
            description = "REST API to fetch  Build Info Loans"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API to fetch  contact Info in Loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
